...
class AuthenticationServiceTest {
        ...
        void verifyToken_shouldThrowException_whenTokenIsExpired() {
                // given
                String expiredToken = createTestToken("user-123", "test@example.com", UserType.CUSTOMER, testSecretKey,
                                -1000);
        ...
        void verifyToken_shouldThrowException_whenSignatureIsInvalid() {
                ...
                String invalidSignatureToken = createTestToken("user-123", "test@example.com", UserType.CUSTOMER,
                                wrongKey, 60000);
